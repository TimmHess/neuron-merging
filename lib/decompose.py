...
def create_scaling_mat_conv_thres(weight, ind, threshold, model_type):
    '''
    ...
    cosine_dist = pairwise_distances(weight, metric="cosine") # why not 1 - pairwise_distance?
    weight_chosen = weight[ind, :]
    scaling_mat = np.zeros([weight.shape[0], weight_chosen.shape[0]])
